...
#For AVS_SDK we need to remove the beepdec and auirdemux plugins to avoid conflicts
do_install_append() {
	rm -v ${D}/${libdir}/gstreamer-1.0/libgstbeepdec.*
	rm -v ${D}/${libdir}/gstreamer-1.0/libgstaiurdemux.*
}
