...
#IMAGE_INSTALL_append = " bjam-native"
IMAGE_INSTALL_append = " boost"
IMAGE_INSTALL_append = " civetweb"
IMAGE_INSTALL_append = " cjson"
...
IMAGE_LINK_NAME = "${MACHINE}-${IMAGE_BASENAME}-${SOUNDCARD}${WAKEWORD}${EXTRAFEATURES}-v${SDKVERSION}"
